...
function [estimate, compute_time] = iltx_estimator(g_bfv, m, K, n_sigma,...
    T2, tE, tau2)
    ...
    [m_comp, k_comp] = compressData(m,K,10);
    ...
    f_est = optimisationInverseTransform(G_opt, L_opt, W_opt, n_sigma);
