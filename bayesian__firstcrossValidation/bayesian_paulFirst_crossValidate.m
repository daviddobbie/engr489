...
for indx = 1:tot_Prior
    ...
    n_std_dev, noise_mean, T2, K2, tau2, f_mean_prior_interpolated, alph_length);
...
function [alpha_axis, intTransform_givenalpha, intTransform_computed_uncertainty, rmse_bayesian]  = ...
    bayesianEstimateIntegralTransform(g_intTransform,  f_answer, n_std_dev, noise_mean, T2, K2, tau2, prior_f, alph_length)
